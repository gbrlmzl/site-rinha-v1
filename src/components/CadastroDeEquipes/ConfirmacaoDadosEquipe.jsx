...
function TelaConfirmacao({dataEquipe, dataJogadores, escudoPreview, onConcordo}) {
    ...
    return(
        <Box>
            <Container>
                ...
                <Box>
                    <Stack spacing={2} sx={{alignItems:"center", flexDirection: "column", justifyContent: "center"}}>
                        {dataJogadores
                            .filter((jogador) => !jogador.disabledPlayer)
                            .map((jogador, index) => (
